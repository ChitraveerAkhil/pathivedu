...
public class AuthUserDetails implements UserDetails {
	...
	private static final long serialVersionUID = -6572960154810774193L;
	...
	public static AuthUserDetails build(User user) {
		...
		return new AuthUserDetails(user.getId(), user.getPhoneNumber(), user.getEmail(), user.getHash(), authorities);
	}
